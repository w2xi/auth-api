...
class Token
{
    ...
    {
        assert(self::$config instanceof Configuration);
        $token   = self::$config->parser()->parse('eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImZvbyI6ImJhciJ9.eyJpc3MiOiJodHRwOlwvXC9leGFtcGxlLmNvbSIsImF1ZCI6Imh0dHA6XC9cL2V4YW1wbGUub3JnIiwianRpIjoiNGYxZzIzYTEyYWEiLCJpYXQiOjE2MTQzNTMzODYsIm5iZiI6MTYxNDM1MzQ0NiwiZXhwIjoxNjE0MzU2OTg2LCJ1aWQiOjF9.N9nD36BrK1kZCs8m0NDLh72IJ1fQW-SJVXHdTC6Xsi4');
    ...
    public function validate($token)
    {
        ...
        return json((array) $token->claims());
